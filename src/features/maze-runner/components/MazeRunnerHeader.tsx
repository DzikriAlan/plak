    ...
    <header className="shrink-0 space-y-3">
      <div className="flex items-stretch gap-2">
        ...
        >
          ...
          <span className="text-base font-black uppercase leading-none tracking-tighter text-[#f2ede1]">Labirin</span>
        </Link>
        ...
        <div className="flex min-w-0 flex-1 items-center justify-between gap-2 rounded-xl border border-[#26262b] bg-[#121214] px-3 py-1">
          ...
          <span className="truncate text-[8px] font-semibold uppercase tracking-[0.2em] text-[#a29d93]">
            {goalLabel}
          </span>
          <span className="shrink-0 text-sm font-black leading-none text-[#f0b429]">{timeLabel}</span>
        </div>
        ...
        <button
          ...
          className="flex shrink-0 flex-col items-center justify-center rounded-xl border border-[#26262b] bg-[#121214] px-3 py-2 transition-colors hover:border-[#43434d] disabled:opacity-45"
        >
