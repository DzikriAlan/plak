...
interface Props {
  ...
  bestScore: number
  lineTotal: number
  onClearTetrisGame: () => void
}

export default function TetrisResult({ resultLabel, score, bestScore, lineTotal, onClearTetrisGame }: Props) {
  const stats = [
    { id: 'score', label: 'Skor', value: String(score) },
    { id: 'lines', label: 'Baris', value: String(lineTotal) },
