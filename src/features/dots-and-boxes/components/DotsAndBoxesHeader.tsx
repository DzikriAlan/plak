...
interface Props {
  onLoadDotsAndBoxesExit: () => void
  isSoundOn: boolean
  isInviteVisible?: boolean
  isInviteLoading?: boolean
  onSubmitDotsAndBoxesInvite?: () => void
  onLoadDotsAndBoxesGuide: () => void
  onEditDotsAndBoxesSound: () => void
}

export default function DotsAndBoxesHeader({
  onLoadDotsAndBoxesExit,
  isSoundOn,
  isInviteVisible = false,
  isInviteLoading = false,
  onSubmitDotsAndBoxesInvite,
  onLoadDotsAndBoxesGuide,
  onEditDotsAndBoxesSound,
}: Props) {
  return (
    <header className="shrink-0 space-y-3">
      <div className="flex min-h-[48px] items-stretch gap-2">
        <button
          type="button"
          onClick={onLoadDotsAndBoxesExit}
        ...
        {isInviteVisible ? (
          <button
            ...
            onClick={onSubmitDotsAndBoxesInvite}
        ...
        <GameSoundToggle isSoundOn={isSoundOn} className="w-[38px] shrink-0" onEditGameSound={onEditDotsAndBoxesSound} />
      </div>
    </header>
  )
}
